...
export class CreateSubDocumentUseCase {
  ...
  async execute(documentId: string, dto: CreateSubDocumentsDto): Promise<SubDocumentEntity[]> {
    ...
    return await this.subDocumentRepository.createMany(documentId, dto.subDocuments);
  }
}
