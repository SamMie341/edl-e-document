...
export class SyncDivisionUseCase {
    ...
    constructor(
        @Inject(divisionRepositoryInterface.DIVISION_REPOSITORY) private readonly externalRepo: divisionRepositoryInterface.IDivisionRepository,
    ...
    async execute() {
        ...
        try {
            ...
            throw new InternalServerErrorException('ບໍ່ສາມາດ Sync ຂໍ້ມູນ Division ໄດ້');
        }
    }
}