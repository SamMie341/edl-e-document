...
export class SyncUserFromHrmUseCase {
    constructor(
        @Inject(userRepositoryInterface.USER_REPOSITORY) private readonly userRepository: userRepositoryInterface.IUserRepository,
    ...
    async execute(empCode: string): Promise<any> {
        try {
            ...
            let validBranchId = null, validDeptId = null, validDivId = null, validOfficeId = null, validUnitId = null;
