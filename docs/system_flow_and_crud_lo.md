...
3. **ການກວດສອບບົດບາດ (Role-Based Access Control - RBAC):** ລະບົບແບ່ງຜູ້ໃຊ້ອອກເປັນ 4 ບົດບາດຫຼັກ:
   * **`SUPER_ADMIN`**: ຄຸ້ມຄອງລະບົບທັງໝົດ, ອະນຸມັດຜູ້ໃຊ້ໃໝ່, ປ່ຽນແປງສິດ (Roles) ແລະ ການຊິງຄ໌ຂໍ້ມູນຈາກ HRM.
   * **`HQ_ADMIN`**: ຜູ້ດູແລລະບົບສ່ວນກາງ (ສຳນັກງານໃຫຍ່). ສາມາດຈັດການ ແລະ ເບິ່ງສະຖານທີ່ຈັດເກັບ, ສາງ, ຕູ້, ຊັ້ນວາງ, ແຟ້ມເອກະສານ ແລະ ປະເພດເອກະສານທັງໝົດທົ່ວປະເທດ, ພ້ອມທັງສາມາດເບິ່ງ ແລະ ຄຸ້ມຄອງເອກະສານໄດ້ທຸກສາຂາ.
   * **`BRANCH_ADMIN`**: ຜູ້ດູແລລະບົບປະຈໍາສາຂາ. ສາມາດຈັດການສະຖານທີ່ຈັດເກັບ, ສາງ, ຕູ້, ຊັ້ນວາງ, ແຟ້ມເອກະສານ ແລະ ຄຸ້ມຄອງເອກະສານສະເພາະພາຍໃນສາຂາ ຫຼື ຝ່າຍຂອງຕົນເອງ.
   * **`USER`**: ພະນັກງານທົ່ວໄປ. ສາມາດສ້າງເອກະສານ, ອັບໂຫລດໄຟລ໌ແນບ, ຄົ້ນຫາເອກະສານ ແລະ ເບິ່ງສະຖານທີ່ຈັດເກັບໄດ້ (ເບິ່ງໄຟລ໌ແນບໄດ້ສະເພາະເອກະສານທີ່ຕົນເອງສ້າງ).
...
```
[Branch] (ສາຂາ) / [Division] (ຝ່າຍ)
   └── [Address] (ສະຖານທີ່ຈັດເກັບ)
...
* **Address (ສະຖານທີ່ຈັດເກັບ):** ລະບຸສະຖານທີ່ຈັດເກັບທາງກາຍະພາບ (ເຊັ່ນ: ຕຶກ, ຫ້ອງ) ທີ່ຂຶ້ນກັບສາຂາ ຫຼື ຝ່າຍໃດໜຶ່ງ ເຊິ່ງເປັນບ່ອນຕັ້ງຂອງສາງເກັບເອກະສານ.
* **Folder (ແຟ້ມ / ໂກໂນ):** ແຟ້ມເກັບເອກະສານຈະມີ QR Code ສະເພາະຕົວ ສໍາລັບການສະແກນເພື່ອລະບຸຕໍາແໜ່ງ.
...
* **Read (ອ່ານ/ຄົ້ນຫາ):**
  ...
  * ເປີດອ່ານ ຫຼື ດາວໂຫລດໄຟລ໌ແນບ (`GetAttachment`) ໂດຍລະບົບຈະມີການກວດສອບສິດ: ຜູ້ໃຊ້ທົ່ວໄປ (`USER`) ຈະເບິ່ງໄດ້ສະເພາະເອກະສານທີ່ຕົນເອງສ້າງເທົັ້ນັ້ນ.
* **Update (ແກ້ໄຂ):**
  * ຜູ້ໃຊ້ລະດັບ `USER` ແກ້ໄຂໄດ້ສະເພາະເອກະສານທີ່ຕົນເອງສ້າງ.
  * `BRANCH_ADMIN` ແກ້ໄຂໄດ້ສະເພາະເອກະສານພາຍໃນສາຂາຂອງຕົນເອງ.
  * `HQ_ADMIN` ສາມາດແກ້ໄຂເອກະສານໄດ້ທັງໝົດ.
* **Delete (ລົບ):**
...
ຄຸ້ມຄອງຫ້ອງ ຫຼື ສາງເກັບເອກະສານຫຼັກຂອງແຕ່ລະສາຂາ.
...
* **Create (ສ້າງ):** ເພີ່ມສະຖານທີ່ຈັດເກັບໃໝ່ (ສະເພາະສິດ `HQ_ADMIN`).
* **Read (ອ່ານ):**
  * ເບິ່ງລາຍການສະຖານທີ່ຈັດເກັບທັງໝົດ (ສະເພາະສິດ `HQ_ADMIN`).
  * ດຶງຂໍ້ມູນ Dropdown ຂອງສະຖານທີ່ຈັດເກັບ (ສິດ `HQ_ADMIN` ແລະ `BRANCH_ADMIN`).
* **Update (ແກ້ໄຂ):** ແກ້ໄຂຂໍ້ມູນສະຖານທີ່ຈັດເກັບ (ສະເພາະສິດ `HQ_ADMIN`).
* **Delete (ລົບ):** ລົບສະຖານທີ່ຈັດເກັບອອກຈາກລະບົບ (ສະເພາະສິດ `HQ_ADMIN`).
...
### 8. ໂມດູນສາຂາ (Branch Module)
* **Read (ອ່ານ):** ຜູ້ໃຊ້ທຸກລະດັບສາມາດເບິ່ງລາຍຊື່ສາຂາທັງໝົດໄດ້.
* **Sync (ຊິງຄ໌):** ຂໍ້ມູນສາຂາຈະຖືກປັບປຸງ/ຊິງຄ໌ໂດຍອັດຕະໂນມັດ ຜ່ານການຊິງຄ໌ຂໍ້ມູນຝ່າຍ (Division Sync).

---

### 9. ໂມດູນພະແນກ (Department Module)
...
### 10. ໂມດູນຝ່າຍ (Division Module)
* **Read (ອ່ານ):** ຜູ້ໃຊ້ທຸກລະດັບສາມາດເບິ່ງລາຍຊື່ຝ່າຍທັງໝົດໄດ້.
* **Sync (ຊິງຄ໌):** ຊິງຄ໌ຂໍ້ມູນຝ່າຍ ແລະ ສາຂາຈາກຖານຂໍ້ມູນ HRM ພາຍນອກ (ສະເພາະສິດ `SUPER_ADMIN`).

---

### 11. ໂມດູນຫ້ອງການ (Office Module)
...
### 13. ໂມດູນຜູ້ໃຊ້ ແລະ ລະບົບຄວາມປອດໄພ (User & Auth Module)
...
### 14. ໂມດູນບັນທຶກປະຫວັດ (Audit Log Module)
